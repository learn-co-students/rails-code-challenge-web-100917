...
Superpower.create(name:"super strength", description: "gives the wielder super human strengths")
Superpower.create(name:"flight", description: "gives the wielder the ability to fly through the skys at supersonic speed")
Superpower.create(name:"super human senses", description: "allows the person to user their senses at super human level")
Superpower.create(name:"elasticity", description: "can stretch the human body to extreme lengths")
